...
#pragma pack(push, 1)
	...
	struct SCharacter {
				...
				double															Speed								=  0; // Cells/second
				double															SpeedMax							= 10; // Cells/second
				double															DirectionInRadians					=  0; // Rotation angle in radians
				int32_t															RigidBody							= -1; // For storing position and physics information
